...
> - Timeline:
>   - ~ 60 days for GitHub Code Archive -> https://github.com/splunk/fluent-plugin-k8s-metrics-agg
>   - ~ 30 days for DockerHub Image Removal -> https://hub.docker.com/repository/docker/splunk/k8s-metrics-aggr
> - Maintenance:
